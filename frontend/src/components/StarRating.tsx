    ...
    <div className="flex items-center gap-1.5">
      <div className="flex items-center">
        {stars.map((n) => {
          ...
          return (
            ...
            >
              <span
                className={`material-symbols-outlined ${starSize} ${filled ? 'text-amber-400' : 'text-zinc-300'} transition-colors`}
      ...
      <button
        ...
        className={`px-2 py-0.5 rounded-full text-[10px] font-black uppercase tracking-widest transition-colors disabled:cursor-default ${
          value === null || value === undefined ? 'bg-zinc-900 text-white' : 'bg-zinc-100 text-zinc-400 hover:bg-zinc-200'
        }`}
      >
        N/A
      </button>
